								...
								<tr>
									...
									<td class="px-4">
										<input class="form-control rounded-0   p-2 mb-2 bg-success bg-opacity-10"
											 name="memberName" type="text" size="40" readonly 
											 value="${memberInfo.memberName }" style="width: 300px;">
									</td>
								</tr>
								<!-- 이름 -->
					...
					<table class="table border-top mb-0 small fw-light">
						<tbody>
							<tr>
								...
								<td class="">
									...
									<div class="row px-4">
										...
										<div class="form-check col-3 ">
											<input class="form-check-input" type="radio"
												name="pay_method" id="pay_method" value="휴대폰결제"> 
							...
							<tr class="whenSelected_Card ">
								<td
									class="table-light ps-4 align-middle bg-success bg-opacity-10 "
									style="width: 200px;">
							...
							<tr class="whenSelected_Phone d-none">
								...
								<td class="px-4"><input class="form-control rounded-0"
									type="text" id="pay_order_hp_num" name="pay_order_tel" value=""
