...
function fn_order_all_cart_goods(){
	...
	if(checkLen > 0){
		...
		//사용자가 뒤로가기 한뒤 다시 주문할때를 대비해 input 값을 되돌려놓음.
	 	for (var i = 0; i < cart_goods_qty.length; i++) {	
	...
	<div class="row ms-5 ps-5">
		<div class="mt-5 p-0 ps-5 align-items-center">
			<div class="ps-4">
				...
				<!-- 선택상품 가격표시 영역 -->
				<p
					class="text-end p-4 text-secondary d-flex justify-content-end align-items-center
					...
					<input id="h_final_totalPrice" type="hidden" value="${totalGoodsPrice}" />
					<!-- 가격정보 hidden input -->

					<span> <!-- 총 상품가격 --> <span>총 상품가격 
					<span id="goodsPrice">${total_goods_sales_price}</span>원
					</span> <span>+</span> <!-- 총 배송비 --> 
					<span>총 배송비 ${totalDeliveryPrice }원</span> <span>=</span> <!-- 총 주문금액 --> 총 주문금액
				...
				<a href="javascript:fn_order_all_cart_goods()"
					class="btn btn-lg btn-main rounded-0 w-100 d-block fw-bold p-2 lh-lg mt-4 mb-2 
								bg-success bg-opacity-10 ">주문하기</a>
				<!-- 선택상품 주문하기 -->
