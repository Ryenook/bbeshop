				...
				<div class="table-responsive mt-4">
					<table class="table border-top mb-0 small fw-light border-bottom">
						<tbody>
							...
							<tr>
								<td
									class="table-light p-2 align-middle fw-bold border-end text-center samll bg-success bg-opacity-10"
									style="width: 45px;">상품번호</td>
								<td
									class="table-light ps-4 align-middle fw-bold text-center border-end bg-success bg-opacity-10">상품정보</td>
								<td
									class="table-light ps-4 align-middle fw-bold text-center border-end bg-success bg-opacity-10">상품이미지</td>
								<td
									class="table-light align-middle fw-bold text-center border-end bg-success bg-opacity-10"
									...
									<td class="border-end align-middle">
										...
										<div class="d-flex mb-1 align-items-center">
											...
											<select
												...
												<option value="와인잔">와인잔</option>
												<option value="맥주잔">맥주잔</option>
												<option value="캐릭터잔">캐릭터잔</option>
