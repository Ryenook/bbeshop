				...
				<div class="table-responsive mt-4">
					<table class="table border-top mb-0 small fw-light border-bottom">
						<!-- <tbody> -->
							...
							<!-- thead -->
							<tr>
								<td class="table-light p-2 align-middle fw-bold border-end text-center samll bg-success bg-opacity-10"
									style="width: 45px;">주문번호</td>
								<td class="table-light ps-4 align-middle fw-bold text-center border-end bg-success bg-opacity-10">주문정보</td>
								<td class="table-light ps-4 align-middle fw-bold text-center border-end  bg-success bg-opacity-10">배송정보</td>
								<td class="table-light align-middle fw-bold text-center border-end bg-success bg-opacity-10">주문날짜</td>
											...
											<c:when test="${item.order_id != pre_order_id }">
												<form name="frm_delivery_list">
													<tr>
														...
														<!-- 주문 id -->
														<td class="table-light align-middle border-end text-center bg-success bg-opacity-10">
															${item.order_id}</td>
														<!-- 주문 id -->
														...
														<td class="border-end align-middle">
															...
															<div class="d-flex mb-1 align-items-center">
																<span style="width: 110px;" class=""> 주문회원 </span> 
																<input class="form-control rounded-0" type="text"  readonly
																		placeholder="회원이름" value="${item.memberId}">
															</div> 
															<!-- 회원 id --> 
															
															<!-- 수령자 이름 -->
															<div class="d-flex mb-1 align-items-center">
																<span style="width: 110px;" class=""> 수령자 </span> 
																<input class="form-control rounded-0" type="text" readonly
															...
															<!-- 배송 연락처 -->
															<div class="d-flex mb-1 align-items-center">
																<span style="width: 110px;" class=""> 배송연락처 </span> 
																<input class="form-control rounded-0" type="text" readonly
														...
														<td class="border-end align-middle">
															<!-- 주문상품이름 -->
															<div class="d-flex mb-1 align-items-center">
																<span style="width: 100px;" class="">주문상품</span> 
																<input class="form-control rounded-0" type="text" readonly
																	...
																	<c:when test="${item.order_id != pre_order_id }">
																		<c:choose>
																			<c:when test="${item.delivery_state=='delivery_prepared' }">
																				<!-- 준비중일때 -->
																				<select name="s_delivery_state${i.index }" id="s_delivery_state${i.index }" onchange="selectValue(this, this.value)"
														...
														<td class="text-center align-middle">
															<!-- 수정하기 --> 
															<input class="w-100 btn border-main small rounded-0 samll mb-2"
																type="button" value="수정" onClick="fn_modify_order_state('${i.index }','${item.order_id}')" />
															<!-- 수정하기 -->
