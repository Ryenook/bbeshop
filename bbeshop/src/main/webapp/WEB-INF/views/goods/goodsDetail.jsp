...
<script type="text/javascript">
	...
	function add_cart(goods_id) {
		if (memberName == "") {
			var confirmation = confirm("로그인후 사용 가능합니다!");
		...
		<div class="p-0 d-flex">
			...
			<div class="ps-4 w-100">
				...
				<div class="d-flex gap-2 mt-4">
					<input type="hidden" id="order_goods_qty" name="order_goods_qty"
						value="1">
					...
					<a
						href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }',
						'${goods.goods_sales_price}','${goods.goods_fileName}');"
