package com.myspring.bbeshop.cart.controller;
...
import com.myspring.bbeshop.cart.service.CartService;
import com.myspring.bbeshop.cart.vo.CartVO;
...
public class CartControllerImpl extends BaseController implements CartController {
	...
	public @ResponseBody String addGoodsInCart(@RequestParam("goods_id") int goods_id, HttpServletRequest request,
		...
		System.out.println(isAreadyExisted);
	...
	public @ResponseBody String modifyCartQty(@RequestParam("goods_id") int goods_id,
		...
		// memberId의 @RequestParam받은 goods_id와 cart_goods_qty에 수정내용을 반영하고 
		// 결과값을 리턴받아 result에 저장
		cartVO.setMemberId(memberId);
		cartVO.setGoods_id(goods_id);
