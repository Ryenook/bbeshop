...
public interface MyPageController {
	...
	// 내 정보 수정
	public ResponseEntity modifyMyInfo(@RequestParam("memberPw") String memberPw, @RequestParam("hp1") String hp1,
	...
	// 주문상세
	public ModelAndView payToOrderdetail(@RequestParam("order_id") String order_id, HttpServletRequest request,
			HttpServletResponse response) throws Exception;
}